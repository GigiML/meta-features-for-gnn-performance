from src.gnn.train_pipeline import train_gnn
import click
...
@click.command()
@click.option('--model_name', '-m', default='GCN', help='Nom du modèle à utiliser (défaut: GCN)')
def main(model_name):
    for dataset in combined_datasets:
        train_gnn(dataset, model_name)
